...
If some functions are not working properly, create a new issue under Issues and follow the template called [Mobile Bug Report](https://github.com/LDF-STUDIO/WahidLink/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
