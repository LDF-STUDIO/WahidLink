...
If some functions are not working properly, create a new issue under [Issues](https://github.com/yhegazy/WahidLinkApp/blob/main/.github/ISSUE_TEMPLATE/bug_report.md) and follow the template.
